  ...
  // const Step3Review: React.FC<Props> = ({ data, back, next }) => {
  //   return (
  //     <div className="container py-4">
  //     <div
  ...
  //       {/* Plan & Order */}
  //       <div className="mb-2"><strong>Plan:</strong> {data.plan?.name}</div>
  //       <div className="mb-2"><strong>Quantity:</strong> {data.orderData?.quantity || 1}</div>
  ...
  //           ₹{data.orderData?.payableAmount?.toLocaleString()}
  //         </span>
  //       </div>
  ...
  //           <span
  //             style={{
  //               color: data.orderData.gstValid ? "green" : "red",
  //               fontWeight: 600,
  //             }}
  //           >
  //             {data.orderData.gstValid ? "✅ Valid" : "❌ Invalid"}
