         ...
         >
          <span className="me-2">
            ...
            <p className="text-white">
              Simplifying payment processing with our intuitive wizard interface.
              Secure, fast, and user-friendly payment solutions for your business.
            </p>
          </div>
        ...
        <div className="row">
          <div className="col-12">
            <div className="text-center text-white">
              <p className="mb-0">&copy; 2024 PaymentWizard. All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
