...
const ChequePrinter: React.FC = () => {
  ...
  const bankLayouts: Record<string, BankLayout> = {
    ...
    axis: {
      date: { top: "13mm", right: "-26mm", letterSpacing: "2.7mm" },
      payto: { top: "28mm", left: "70mm" },
      words: { top: "33mm", left: "77mm" },
      number: { top: "45mm", right: "-15mm" },
    },
    pnb: {
      date: { top: "14mm", right: "-28mm", letterSpacing: "2.8mm" },  //t=14 , r=-28 , l=2.8  
      payto: { top: "27mm", left: "70mm" },//t=27  , l=70 
      words: { top: "32mm", left: "77mm" }, //t=32 , l=77
      number: { top: "43mm", right: "-17mm" }, //t=43 , l=-17
    },
    hdfc: {
      date: { top: "15mm", right: "-30.5mm", letterSpacing: "3mm" },
      payto: { top: "26mm", left: "70mm" },
      words: { top: "31mm", left: "77mm" },
      number: { top: "43mm", right: "-18mm" },
    },
    indusind: {
      date: { top: "15mm", right: "-31mm", letterSpacing: "3mm" },
      payto: { top: "27mm", left: "70mm" },
      words: { top: "32mm", left: "77mm" },
      number: { top: "45mm", right: "-18mm" },
    },
    kotak: {
      date: { top: "17mm", right: "-29mm", letterSpacing: "3mm" },//t=14 , r=-28 , l=2.8  
      payto: { top: "27mm", left: "65mm" },//t=27  , l=70 
      words: { top: "30mm", left: "72mm" },//t=32 , l=77
      number: { top: "46mm", right: "-17mm" },//t=43 , l=-17
    },
    boi: {
      date: { top: "18mm", right: "-31mm", letterSpacing: "3mm" },
      payto: { top: "31mm", left: "80mm" },
      words: { top: "35mm", left: "94mm" },
      number: { top: "46mm", right: "-17mm" },
    },
  };
...
//     },
//     pnb: {
//       date: { top: "14mm", right: "-28mm", letterSpacing: "2.8mm" },
//       payto: { top: "27mm", left: "70mm" },
//       words: { top: "32mm", left: "77mm" },
//       number: { top: "43mm", right: "-17mm" },
//     },
//     hdfc: {
//       date: { top: "14mm", right: "-14mm", letterSpacing: "3mm" },
//       payto: { top: "26mm", left: "55mm" },
//       words: { top: "34mm", left: "55mm" },
//       number: { top: "42mm", right: "-3mm" },
//     },
//     indusind: {
...
//   const getCurrentLayout = () => bankLayouts[selectedBank];

//   // --------------- 🟦 PREVIEW HTML (LIVE VIEW) -------------------
//   const renderPreview = () => {
//     const layout = getCurrentLayout();
//     return (
//       <div
...
//           style={{
//             position: "absolute",
//             top: layout.payto.top,
//             left: layout.payto.left,
//           }}
//         >
//           {chequeData.payTo}
//         </div>
...
//           style={{
//             position: "absolute",
//             top: layout.words.top,
//             left: layout.words.left,
//             whiteSpace: "pre-line",
//             width: "120mm",
//           }}
//         >
...
//     const chequeHTML = `
//       <div style="width:210mm; height:100mm; position:relative;">
//         <div style="position:absolute; top:${layout.date.top}; right:${layout.date.right}; letter-spacing:${layout.date.letterSpacing}">
//           ${chequeData.date}
//         </div>
//         <div style="position:absolute; top:${layout.payto.top}; left:${layout.payto.left}">
...
//   return (
//     <main className="d-flex flex-column align-items-center p-3">
//       <div className="card shadow-lg" style={{ maxWidth: "500px", width: "100%" }}>
//         <div className="p-4 text-white" style={{ background: "#0B7456" }}>
//           <h2 className="fw-bold">Smart Cheque Printer</h2>
//         </div>
...
//           {/* Inputs */}
//           <div className="mb-3">
//             <label className="fw-semibold">Date (DDMMYYYY)</label>
//             <input
//               type="text"
...
//           <div className="mb-3">
//             <label className="fw-semibold">Pay To</label>
//             <input
//               type="text"
//               className="form-control"
//               value={chequeData.payTo}
...
//             <strong>Words:</strong> {chequeData.amountWords || "---"}
//           </div>

//           <div className="mb-3">
//             <label className="fw-semibold">Select Bank</label>
//             <select
...
//           <h5 className="mt-4 mb-2 fw-bold">Cheque Preview</h5>
//           {renderPreview()}
